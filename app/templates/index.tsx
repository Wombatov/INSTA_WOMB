...
export default function TemplatesScreen() {
  ...
  const setPendingEditorText = usePreviewStore((s) => s.setPendingEditorText);
  ...
  const onCompleteApply = useCallback(
    (resolvedText: string) => {
      ...
      setPendingEditorText(resolvedText);
      setTemplateDraftPostId(post.id);
      router.push('/(tabs)/editor' as Href);
    },
    [createPost, setPendingEditorText, setTemplateDraftPostId]
  );
